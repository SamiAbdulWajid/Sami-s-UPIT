...
//   //     setCurrentIndex(selectedFileIndex); // reset to first file
//   //   }
//   // }, [project,selectedFileIndex]);
...
//   // ✅ Save handler with await axios
//     // ✅ Corrected save handler aligned with server.js
//   async function handleSave() {
//     console.log("Save button clicked ✅");

//     // Ensure a project with an ID exists before attempting to save
...
//     try {
//       // Use PATCH to match the `app.patch("/projects/:_id", ...)` route in your server.js
//       const res = await axios.patch(`http://localhost:8080/projects/${project._id}`, { 
//         files: files 
//       });
...
//       // This provides more detailed error info from your server
//       if (err.response) {
...
//     <span
//       onClick={(e) => {
//         e.stopPropagation(); // stop triggering file selection
  ...
  async function handleSave() {
    ...
    try {
      ...
      const res = await axios.patch(
        `http://localhost:8080/projects/${project._id}/files`,
        { files: files },
