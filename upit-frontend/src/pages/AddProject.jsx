...
export function AddProject() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post("https://sami-s-upit-backend.onrender.com", formData, {
  ...
  return (
    ...
    >
      ...
      >
        <h3 className="text-center mb-3">Add Project</h3>
    ...
    onDrop={e => {
      ...
      // const onlyFiles = fileList.filter(f => f.type !== "");
